package com.example.homeinventory.ui.search
...
import com.example.homeinventory.databinding.FragmentSearchBinding
...
class SearchFragment : Fragment() {
    ...
    private fun openItem(item: Inventory.Item, position: Int) {
        InvUtils.itemPopup(
